...
import consultationChat from './assets/iconchat.png'
...
<template>
  <div v-if="!admin" class="site-shell">
    ...
    <main>
      ...
      <section id="kontak" class="contact"><div><p class="eyebrow">KONSULTASI AWAL</p><h2>Butuh konsultasi notaris?</h2><p>Alamat Kantor Notaris, PPAT, NPAK, &amp; Notaris Pasar Modal Jakarta Selatan<br/>Salfa Novia Roza, S.H., M.Kn.</p><div class="contact-meta"><a href="https://maps.app.goo.gl/VD6PphJXQaMMVmD1A?g_st=iw" target="_blank" rel="noopener noreferrer"><MapPin :size="14"/>Jl. KH. Ahmad Dahlan Kby. No.10 D, RT.1/RW.1, Kramat Pela, Kec. Kby. Baru, Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12130</a></div></div><div class="contact-actions"><a class="button" href="https://wa.me/6282241145758?text=Halo%20Saya%20dari%20website%20https%3A%2F%2Fsalfanoviaroza.com%2F%20ingin%20konsultasi." target="_blank" rel="noopener noreferrer">WhatsApp Kami</a></div></section>
    </main><a class="floating-consultation" href="https://wa.me/6282241145758?text=Halo%20Saya%20dari%20website%20https%3A%2F%2Fsalfanoviaroza.com%2F%20ingin%20konsultasi." target="_blank" rel="noopener noreferrer" aria-label="Konsultasi melalui WhatsApp"><img :src="consultationChat" alt="Konsultasi Sekarang"/></a><footer><button class="brand"><Scale :size="22"/><span>Notaris, PPAT, NPAK, &amp; Notaris Pasar Modal Jakarta Selatan</span></button><span>© 2026 Salfa Novia Roza, S.H., M.Kn. Seluruh hak dilindungi.</span></footer>
  </div>
